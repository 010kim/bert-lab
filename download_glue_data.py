...
def format_mrpc(data_dir, path_to_data):
    ...
    with open(mrpc_test_file, encoding='utf-8') as data_fh, open(os.path.join(mrpc_dir, "test.tsv"), 'w', encoding='utf-8') as test_fh:
    ...
    try:
        ...
        print("\tManually inserted dev_ids.tsv")
    ...
    with open(mrpc_train_file, encoding='utf-8') as data_fh, open(os.path.join(mrpc_dir, "train.tsv"), 'w', encoding='utf-8') as train_fh, open(os.path.join(mrpc_dir, "dev.tsv"), 'w', encoding='utf-8') as dev_fh:
        header = data_fh.readline()
...
def main(arguments):
    ...
    parser.add_argument('--path_to_mrpc', type=str, default='')
